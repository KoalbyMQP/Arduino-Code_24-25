...
Motor Left_Wrist_Abductor               = {26, -125, -20, -120, false, "Left_Wrist_Abductor"};
Motor Left_Elbow                        = {1, -125, -20, -120, true, "Left_Elbow"};
Motor Left_Arm_Rotator                  = {2, -160, 160, -90, false, "Left_Arm_Rotator"};
Motor Left_Arm_Abductor                 = {3, -120, 140, 42, true, "Left_Arm_Abductor"}; // limited by wire

// Right Arm (Wrist to Shoulder)
Motor Right_Wrist_Abductor              = {25, -135, 35, -20, false, "Right_Wrist_Abductor"};
Motor Right_Elbow                       = {11, -70, 130, -40, true, "Right_Elbow"};
Motor Right_Arm_Rotator                 = {10, -160, 160, 20, false, "Right_Arm_Rotator"};
Motor Right_Arm_Abductor                = {6, -30, 80, 15, true, "Right_Arm_Abductor"};

// Chest/Neck (Top to Bottom, Left to Right, Front to Back)
Motor Top_Neck                          = {28, 35, 110, 90, false, "Top_Neck"};
Motor Bottom_Neck                       = {27, -20, 160, 90, false, "Bottom_Neck"};
Motor Left_Shoulder                     = {7, -160, 160, -50, true, "Left_Shoulder"};
Motor Right_Shoulder                    = {15, -160, 90, 43, true, "Right_Shoulder"};
Motor Front_Chest                       = {18, -155, 160, -112, false, "Front_Chest"};
Motor Back_Chest                        = {17, -155, 20, -60, false, "Back_Chest"};

// Pelvis (Top to Bottom, Left to Right, Front to Back
Motor Hips_Rotate_Upper_Body            = {19, -160, 120, -90, false, "Hips_Rotate_Upper_Body"};
Motor Hips_Lean_Side_To_Side            = {21, -160, 110, 100, true, "Hips_Lean_Side_To_Side"};
Motor Hips_Bend_Over                    = {22, -90, 40, 25, true, "Hips_Bend_Over"};
Motor Left_Leg_Abductor_Front_To_Back   = {9, -20, 35, 4, false, "Left_Leg_Abductor_Front_To_Back"};
Motor Right_Leg_Abductor_Front_To_Back  = {8, -60, -5, -45, false, "Right_Leg_Abductor_Front_To_Back"};

// Left Leg (Foot to Hip)
Motor Left_Leg_Rotator                  = {14, 20, 160, -10, false, "Left_Leg_Rotator"};
Motor Left_Leg_Abductor_Side_To_Side    = {30, -130, 160, 30, true, "Left_Leg_Abductor_Side_To_Side"};
Motor Left_Knee                         = {12, -130, 0, -40, false, "Left_Knee"};
Motor Left_Ankle                        = {13, -25, 50, 14, false, "Left_Ankle"};

// Right Leg (Foot to Hip
Motor Right_Leg_Rotator                 = {4, -160, 160, 147, false, "Right_Leg_Rotator"};
Motor Right_Leg_Abductor_Side_To_Side   = {31, -160, 110, 0, true, "Right_Leg_Abductor_Side_To_Side"};
Motor Right_Knee                        = {20, -10, 120, 15, false, "Right_Knee"};
Motor Right_Ankle                       = {5, -40, 40, 0, false, "Right_Ankle"};
