...
Motor Hips_Rotate_Upper_Body = {19, -160, 160, -49, false, "Hips_Rotate_Upper_Body"}; 
Motor Hips_Lean_Side_To_Side = {21, -160, 160, 29, true, "Hips_Lean_Side_To_Side"};
Motor Hips_Bend_Over = {22, -38, 22, 1, true, "Hips_Bend_Over"};
Motor Left_Leg_Abductor_Side_To_Side = {8, -160, 160, -147, false, "Left_Leg_Abductor_Side_To_Side"}; 
...
Motor Left_Leg_Abductor_Front_To_Back = {30, -318, 160, -158, true, "Left_Leg_Abductor_Front_To_Back"};
