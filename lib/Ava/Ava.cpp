...
Motor Left_Arm_Abductor = {3, -150, 45, -10, true, "Left_Arm_Abductor"}; // limited by wire
...
Motor Right_Arm_Rotator = {10, -160, 160, -62, false, "Right_Arm_Rotator"};
...
Motor Right_Shoulder = {15, -160, 160, -40, true, "Right_Shoulder"};
Motor Front_Chest = {18, -30-45, -30+45, 2, false, "Front_Chest"};
Motor Back_Chest = {17, 26-90, 26+90, -62, false, "Back_Chest"};

// Pelvis (Top to Bottom, Left to Right, Front to Back
Motor Hips_Rotate_Upper_Body = {19, -140, 160, -18, false, "Hips_Rotate_Upper_Body"};
...
Motor Right_Leg_Abductor_Side_To_Side = {9, 91, 107, 140, false, "Right_Leg_Abductor_Side_To_Side"};

// Left Leg (Foot to Hip)
Motor Left_Leg_Rotator = {14, -20, 160, 57, false, "Left_Leg_Rotator"};
Motor Left_Leg_Abductor_Front_To_Back = {30, 19, 155, 119, true, "Left_Leg_Abductor_Front_To_Back"};
Motor Left_Knee = {12, -125, -8, -68, false, "Left_Knee"};
Motor Left_Ankle = {13, -80, -5, -63, false, "Left_Ankle"};
...
Motor Right_Ankle = {5, -23, 54, 56, false, "Right_Ankle"};
