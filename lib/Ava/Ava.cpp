...
Motor Hips_Rotate_Upper_Body = {19, -160, 160, 50, true, "Hips_Rotate_Upper_Body"}; 
...
Motor Left_Leg_Abductor_Side_To_Side = {8, -160, 250, 166, true, "Left_Leg_Abductor_Side_To_Side"}; 
