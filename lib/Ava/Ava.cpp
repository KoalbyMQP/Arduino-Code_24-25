...
Motor Right_Arm_Rotator = {10, -160, 160, -29, false, "Right_Arm_Rotator"};   
...
//motors taken out in MQP 24/25 and no longer used 
...
Motor Hips_Bend_Over = {22, -38, 50, -25, true, "Hips_Bend_Over"};
Motor Left_Leg_Abductor_Side_To_Side = {8, -160, 160, -98, true, "Left_Leg_Abductor_Side_To_Side"}; 
Motor Right_Leg_Abductor_Side_To_Side = {9, -160, 160, -55, true, "Right_Leg_Abductor_Side_To_Side"};
...
Motor motors[MOTOR_COUNT] = {
    ...
    Hips_Rotate_Upper_Body, Right_Knee, Hips_Lean_Side_To_Side,                                   // 17 - 21
