...
void setup()  
{
  ...
  Herkulex.torqueON(Left_Leg_Abductor_Side_To_Side.hexID);
  Herkulex.torqueON(Left_Knee.hexID);
  Herkulex.torqueON(Right_Leg_Abductor_Side_To_Side.hexID);
  Herkulex.torqueON(Right_Knee.hexID);
  delay(100);
}

void loop() {
  // Serial.println(Herkulex.getAngle(Right_Shoulder.hexID, Right_Leg_Abductor_Side_To_Side.is0601));

  // Left Arm Up
  Herkulex.moveOneAngle(Right_Leg_Abductor_Side_To_Side.hexID, -79, 2000, LED_GREEN, Right_Leg_Abductor_Side_To_Side.is0601);
  Herkulex.moveOneAngle(Left_Shoulder.hexID, -10, 2000, LED_GREEN, Left_Shoulder.is0601);
  delay(2500);

  // Right Arm Up
  Herkulex.moveOneAngle(Left_Shoulder.hexID, 100, 2000, LED_GREEN, Left_Shoulder.is0601);
  Herkulex.moveOneAngle(Right_Shoulder.hexID, 10, 2000, LED_GREEN, Right_Shoulder.is0601);
  delay(2500);
  
  // Left Leg Up
  Herkulex.moveOneAngle(Right_Shoulder.hexID, -90, 2000, LED_GREEN, Right_Shoulder.is0601);
  Herkulex.moveOneAngle(Left_Leg_Abductor_Side_To_Side.hexID, 50, 2000, LED_GREEN, Left_Leg_Abductor_Side_To_Side.is0601);
  delay(2500);

  // Right Leg Up
  Herkulex.moveOneAngle(Left_Leg_Abductor_Side_To_Side.hexID, 107, 2000, LED_GREEN, Left_Leg_Abductor_Side_To_Side.is0601);
  Herkulex.moveOneAngle(Right_Leg_Abductor_Side_To_Side.hexID, -30, 2000, LED_GREEN, Right_Leg_Abductor_Side_To_Side.is0601);
  delay(2500);
}