...
enum Commands { Init = 0, GetPosition = 1, SetPosition = 2,
                ...
                SetCompliant = 6,/*Set torque to "on" or "off" based on ID*/
                Shutdown = 100
              };
...
class ArduinoPoppy {
  ...
  private:
    ...
    Motor RightUpperConnector =   {0x03,   15,    166,      30,        HERK};    //2   * Motor 3 - Herkulex, Right Arm Connector
    Motor RightShoulder =         {0x0F,    -160,   107,     -74,       HERK};    //3   * Motor F - Herkulex, Right Shoulder
    ...
    Motor LeftShoulder =          {0x07,     130,    -125,   50,        HERK};    //7   * Motor F - Herkulex, Left Shoulder
